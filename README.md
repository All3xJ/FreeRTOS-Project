...
### [CORTEX_MPS2_TASK_SCHEDULING_PREEMPTION](https://github.com/All3xJ/FreeRTOS-Project/tree/CORTEX_MPS2_TASK_SCHEDULING_PREEMPTION)
...
### [CORTEX_MPS2_TASK_SCHEDULING_NO_PREEMPTION](https://github.com/All3xJ/FreeRTOS-Project/tree/CORTEX_MPS2_TASK_SCHEDULING_NO_PREEMPTION)
...
### [modified-best-fit](https://github.com/All3xJ/FreeRTOS-Project/tree/modified-best-fit)
...
### [modified-worst-fit](https://github.com/All3xJ/FreeRTOS-Project/tree/modified-worst-fit)
...
### [cortex_MPS2-genova](https://github.com/All3xJ/FreeRTOS-Project/tree/CORTEX_MPS2-genova)
...
### [CORTEX_MPS2-Moscato](https://github.com/All3xJ/FreeRTOS-Project/tree/CORTEX_MPS2-Moscato)
...
### [cortex_MPS2_Sambataro](https://github.com/All3xJ/FreeRTOS-Project/tree/cortex_MPS2_Sambataro)
...
### [CORTEX_MPS2-Cornaggia](https://github.com/All3xJ/FreeRTOS-Project/tree//CORTEX_MPS2-Cornaggia/-branch)
...
### [CORTEX_MPS2_SEMAPHORE_EX](https://github.com/All3xJ/FreeRTOS-Project/tree/CORTEX_MPS2_SEMAPHORE_EX)
...
### [no-coaleshing-best-fit ](https://github.com/All3xJ/FreeRTOS-Project/tree/no-coaleshing-best-fit)
A **modified Best-fit** version that does not implement coaleshing.

### [heap4_best_fit_allocator](https://github.com/All3xJ/FreeRTOS-Project/tree/heap4_best_fit_allocator)
This branch contains a first and bugged version of the implementation of **Best-Fit algorithm** for memory management. 


### [heap4_worst_fit_allocator](https://github.com/All3xJ/FreeRTOS-Project/tree/heap4_worst_fit_allocator)
